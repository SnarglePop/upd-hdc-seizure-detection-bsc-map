                ...
                for result in ["seizures", "non-seizures"]:
                    ...
                    for exc in files_patient:
                        ...
                        for i in range(wins):
                            ...
                            lasttotal = hex(int("".join(map(str,last)),2))[2:130]
                            print(f"win 1 - {lasttotal}...")
                            seizhv = np.array(am[0],int)
                            seizhv_tot = hex(int("".join(map(str,seizhv)),2))[2:20]
                            print(f"seiz - {seizhv_tot}...")
                            nonseizhv = np.array(am[1],int)
                            nonseizhv_tot = hex(int("".join(map(str,nonseizhv)),2))[2:20]
                            print(f"nonseiz - {nonseizhv_tot}...")
                            with open("first_win.txt", 'a') as f:
                                f.write(f"{lasttotal}\n")
                            # print(res)
                            if arch == 0:
