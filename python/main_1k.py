...
if __name__ == "__main__":
    ...
    for arch in architecture:
        ...
        for feat in training_features:
            if feat == 1:
                memory = [np.loadtxt("memory/feature1/BSC_1k_0.txt", int),np.loadtxt("memory/feature1/BSC_1k_1.txt", int)]
                ...
                for result in ["seizures", "non-seizures"]:
                    ...
                    for exc in files_patient:
                        ...
                        for i in range(wins):
                            ...
                            with open(f"first_win_1k_{window_size}win.txt", 'a') as f:
                                f.write(f"{lasttotal}\n")
                            # print(res)
                            if arch == 0:
